...
import javaE_Commerce_Lab.order.OrderService;
import javaE_Commerce_Lab.order.OrderServiceImpl;
...
import static javaE_Commerce_Lab.DataGenerator.*;
...
public class Main {
        ...
        while (true) {
            ...
            switch (menuSelection) {
                ...
                case 4: // add balance
                    ...
                    System.out.println("Type 1 for customer balance: " + cBalance.getBalance());
                    System.out.println("Type 2 for gift cart balance: " + gBalance.getBalance());
                    ...
                    switch (balanceAccountSelection) {
                        case 1:
                            cBalance.addBalance(additionalAmount);
                            System.out.println("New Customer Balance: " + cBalance.getBalance());
                            break;
                        case 2:
                            gBalance.addBalance(additionalAmount);
    ...
    private static void printAddressByCustomerId(Customer customer) {
        for (Address address : customer.getAddress()) {
            System.out.println(" Street Name: " + address.getStreetName() + " Street Number: " +
                    address.getStreetNumber() + "ZipCode:  " + address.getZipCode() +
    ...
    private static void printOrdersByCustomerId(UUID customerId) {
        for (Order order : StaticConstants.ORDER_LIST) {
            if(order.getCustomerId().toString().equals(order.getId())){
    ...
    private static GiftCardBalance findGiftCardBalance(UUID customerId){
            ...
            GiftCardBalance giftCardBalance = new GiftCardBalance(customerId, 0.0);

package javaE_Commerce_Lab.order;

import javaE_Commerce_Lab.Cart;
import javaE_Commerce_Lab.StaticConstants;
import javaE_Commerce_Lab.checkout.CheckoutService;
import javaE_Commerce_Lab.checkout.CustomerBalanceCheckoutServiceImpl;
import javaE_Commerce_Lab.checkout.MixPaymentCheckoutServiceImpl;
...
public class OrderServiceImpl implements OrderService{
    ...
    public String placeOrder(Cart cart) {
        ...
        if (checkoutResult){
            Order order = new Order(UUID.randomUUID(), LocalDateTime.now(), cart.calculateCartTotalAmount(), amountAfterDiscount, cart.calculateCartTotalAmount() - amountAfterDiscount,
